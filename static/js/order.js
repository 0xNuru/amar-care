document.addEventListener("DOMContentLoaded", function() {
    ...
    placeOrderButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            newModal = new bootstrap.Modal(document.getElementById("prescription-verifier"));
            newModal.show();
        });
    });
    ...
    submitButton.addEventListener("click", function() {
        ...
        const url = `https://medical-presciption-detector.onrender.com/process-image/${encodeURIComponent(selectedResultName)}`;
        ...
        .then(data => {
            ...
            if (data["drugExist"] && data["isPrescription"]) {
                ...
                modal.show();
                    ...
                    newModal.hide();
                    newModal = new bootstrap.Modal(document.getElementById("not-presciption"));
                    newModal.show();
                }
                ...
                errorMessageElement.innerText = error["detail"] || "An unexpected error occurred. Please try again.";
                newModal.show()
            }
        }
        )
